          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                ...
                <span>{props.t("Past Events")}</span>
              </Link>
              <ul className="sub-menu" >
                <li>
                  <Link to="/email-inbox">{props.t("Cultural Events")}</Link>
                </li>
                <li>
                  <Link to="/email-read">{props.t("Sports Events")} </Link>
                </li>
                <li>
                  <Link to="/email-compose">{props.t("Club Events")} </Link>
                </li>
              </ul>
            </li>
            ...
            <li></li>
            <li>
              <Link to="/ongoin" className="waves-effect">
                <i className="mdi mdi-view-dashboard"></i>
                <span className="badge rounded-pill bg-primary float-end">2</span>
                <span>{props.t("On going Events")}</span>
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/icons-materialdesign" className=" waves-effect">
                <i className="mdi mdi-billboard"></i>
                <span className="badge rounded-pill bg-success float-end">New</span>
                <span>Add Past Events</span>
              </Link>
            </li>
            <li>
              <Link to="/getdata" className=" waves-effect">
                <i className="mdi mdi-billboard"></i>
                <span className="badge rounded-pill bg-success float-end">New</span>
                <span>Past Year Data</span>
              </Link>
            </li>
            <li>
              <Link to="/g" className=" waves-effect">
                <i className="mdi mdi-billboard"></i>
                <span className="badge rounded-pill bg-success float-end">New</span>
            ...
            {/* <li>
              <Link to="/#" className="has-arrow waves-effect">
                ...
                <span>{props.t("past year data")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
            ...
            <li>
              <Link to="/#" className="waves-effect">
                ...
                <span>{props.t("past year analytics")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
